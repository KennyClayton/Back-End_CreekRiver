...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20230922203355_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Campsite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_1120,q_60/v1683846899/land-photos/cylaydbzi96nta6h5oms.jpg",
                            Nickname = "Screechy Rooster Mornings Campgrounds"
                        },
                        new
                        {
                            Id = 3,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://explorerchick.com/wp-content/uploads/2023/08/campsite1.jpg",
                            Nickname = "Explorer's Respite"
                        },
                        new
                        {
                            Id = 4,
                            CampsiteTypeId = 4,
                            ImageUrl = "https://en.pimg.jp/084/266/196/1/84266196.jpg",
                            Nickname = "The Sleepy Sloth"
                        },
                        new
                        {
                            Id = 5,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://www.visitarizona.com/places/parks-monuments/patagonia-lake-state-park/",
                            Nickname = "Wrangled Wildlife Campsites"
                        },
                        new
                        {
                            Id = 6,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://static01.nyt.com/images/2021/04/25/multimedia/25ah-camping/merlin_186621867_547397c8-d887-4bbb-a094-d17f15b6cd95-jumbo.jpg?quality=75&auto=webp",
                            Nickname = "FreeCamp Campgrounds"
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 2,
                            CheckinDate = new DateTime(2022, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2022, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckoutDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserProfileId = 2
                        });
                });
